            ...
            <RevealOnScroll>
                <div className="px-4 w-150">
                    ...
                    <form action="" className='space-y-6' onSubmit={handleSubmit}>
                        ...
                        <div className="relative">
                            <textarea id='message' name='message' rows={5} required className='w-full bg-white/5 border border-white/10 rounded px-4 py-3 text-white transition focus:outline-none focus:border-blue-500 focus:bg-blue-500/5' placeholder='Write your message...' value={formData.message} onChange={(e) => setFormData({ ...formData, message: e.target.value })} />
                        </div>
